...
# on the strings returned from the inference engine (vllm). This is because:
...
async def generate(args, sample: Sample, sampling_params) -> Sample:
    ...
    # Without a stop, vllm keeps emitting tokens after </search> / </answer>
    ...
    # vime already sets no_stop_trim=True, so the closing tag is kept in the output.
